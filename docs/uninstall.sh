#!/usr/bin/env bash
# LightEditorVidz — one-line uninstaller for macOS and Linux.
#
#   curl -fsSL https://raw.githubusercontent.com/light-editor-vidz/light-editor-vidz/main/uninstall.sh | bash
#
...
REPO="light-editor-vidz/light-editor-vidz"
TAP="light-editor-vidz/tap"
CASK="light-editor-vidz"
APP_NAME="LightEditorVidz"
APP_SLUG="light-editor-vidz"
DEB_PACKAGE="light-editor-vidz"
ICON_SIZE="512x512"
